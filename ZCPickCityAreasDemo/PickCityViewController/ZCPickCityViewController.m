...
#import "ZCPickCityViewController.h"
#import "ZCPickAreaTableViewCell.h"
#import "ZCPickAreaHeadView.h"

@interface ZCPickCityViewController ()<UITableViewDelegate, UITableViewDataSource, ShowCityDelegate>
...
@implementation ZCPickCityViewController
...
- (void)viewDidLoad {
    ...
    // 本地地区数据源 txt
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"ZCCity" ofType:@"txt"];
...
- (void)createSelAreaTableView
{
    ...
    [self.selAreaTableView registerClass:[ZCPickAreaTableViewCell class] forCellReuseIdentifier:@"selectCell"];
    [self.selAreaTableView registerClass:[ZCPickAreaHeadView class] forHeaderFooterViewReuseIdentifier:@"slectHeader"];
...
{
    ZCPickAreaTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"selectCell" forIndexPath:indexPath];
...
- (void)selectCity:(UIButton *)select
{
    ...
    for (UIView *subViews in self.selAreaTableView.subviews) {
        if (subViews.tag == self.selectIndex + 100) {
            ZCPickAreaHeadView *headerView = (ZCPickAreaHeadView *)subViews;
...
{
    ZCPickAreaHeadView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"slectHeader"];
