...
#import "ZCShowCityTableViewCell.h"
...
- (void)viewDidLoad {
    ...
    [self.areasTableView registerClass:[ZCShowCityTableViewCell class] forCellReuseIdentifier:@"areaSee"];
...
{
    ZCShowCityTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"areaSee" forIndexPath:indexPath];
...
{
    CGFloat cellHeight = [ZCShowCityTableViewCell configureAreaSeeCellHeightWithDic:self.areaArray[indexPath.row]];
    return cellHeight;
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ZCPickCityViewController *selAreaVc = [[ZCPickCityViewController alloc]init];
